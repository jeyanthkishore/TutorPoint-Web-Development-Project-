...
const mailSender = (req, res) => {
  ...
  async function main() {
    ...
    let info = await transport.sendMail({
      ...
      html:
        "<h3>Respected Faculty,</h3><br><h4>This is regarding an application submitted the by student " +
        studentName +
        " to tutor for one of your courses " +
        courseName +
        " - " +
        courseId +
        " <br> Please go through the attached documents and the application to make a decision. <br> Also, you can directly contact the student at " +
        studentMail +
